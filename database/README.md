...
```bash
DB_HOST=dpg-d4hrq17diees73bovsqg-a.oregon-postgres.render.com
DB_PORT=5432
DB_NAME=notebook_webapp
DB_USER=notebook_webapp_user
DB_PASSWORD=CEeZ94Tg0Yj3Wkwu35tVMcFoAjYE9mmm
DATABASE_URL=postgresql://notebook_webapp_user:CEeZ94Tg0Yj3Wkwu35tVMcFoAjYE9mmm@dpg-d4hrq17diees73bovsqg-a.oregon-postgres.render.com/notebook_webapp
```
